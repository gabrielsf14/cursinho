...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { date: @presence.date, is_present: @presence.is_present, student_id: @presence.student_id } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { date: @presence.date, is_present: @presence.is_present, student_id: @presence.student_id } }
